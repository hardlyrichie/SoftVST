...
public:
    ...
    void trigger (Type velocity) noexcept
    {
        ...
        {
            auto value = jmap (Type (i), Type (0), Type (forwardTriggerIndex), Type (0), velocity / 2);
        ...
        {
            auto value = jmap (Type (i), Type (forwardTriggerIndex), Type (getDelayLineLength() - 1), velocity / 2, Type (0));
            forwardDelayLine .set (i, value);
            backwardDelayLine.set (getDelayLineLength() - 1 - i, value);
        }
    }
